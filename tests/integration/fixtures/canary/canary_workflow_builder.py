...
# Fixture library settings on disk. We avoid using griptape_nodes_library.json so it is
# not picked up in production by a recursive scan.
CANARY_LIBRARY_SCHEMA = CANARY_LIBRARY_DIR / "canary_library_schema.json"
# Destination file name when copying settings to a tmp directory for tests.
