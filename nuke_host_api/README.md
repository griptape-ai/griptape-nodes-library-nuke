...
capability 3) to tell one run's notifications from another's. Two connected Nuke clients
...
disconnect signal (see constraint 3), so idleness, not a socket closing, is what frees a
